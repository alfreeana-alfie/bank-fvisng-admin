...
class AddNewFdrPage extends StatefulWidget {
  const AddNewFdrPage({Key? key}) : super(key: key);

  @override
  _AddNewFdrPageState createState() => _AddNewFdrPageState();
}

class _AddNewFdrPageState extends State<AddNewFdrPage> {
