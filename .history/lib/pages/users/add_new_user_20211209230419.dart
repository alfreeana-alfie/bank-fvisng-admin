...
class _AddNewUserPageState extends State<AddNewUserPage> with TickerProviderStateMixin {
  ...
  void addNew(
      BuildContext context, Map<String, String> body, profilePicture) async {
    ...
    // await http.put(addNewUser, headers: Values.headers, body: {
    //   "name": name,
    //   "email": email,
    //   "password": password,
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(
              ...
              right: Values.horizontalValue * 2),
          child: Container(
              child: ElevatedButton(onPressed: getImage, child: _buildImage())),
          // TextFieldCustom(
