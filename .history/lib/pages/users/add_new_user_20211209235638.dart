...
class _AddNewUserPageState extends State<AddNewUserPage> {
  ...
  late ImagePicker _imageFile = ImagePicker();

  Future _onAddImageClick() async {
    final pickedFile = await _imageFile.pickImage(
      source: ImageSource.gallery
    );
    setState(() {
      _imageFile = pickedFile as ImagePicker;
    });
  }

  void addNew(BuildContext context, Map<String, String> body) async {
