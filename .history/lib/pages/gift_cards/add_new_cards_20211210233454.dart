...
class AddNewGiftCardPage extends StatefulWidget {
  const AddNewGiftCardPage({Key? key}) : super(key: key);

  @override
  _AddNewGiftCardPageState createState() => _AddNewGiftCardPageState();
}

class _AddNewGiftCardPageState extends State<AddNewGiftCardPage> {
