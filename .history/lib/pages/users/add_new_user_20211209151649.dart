...
class _AddNewUserPageState extends State<AddNewUserPage> {
  ...
  Future addNew(name, email, password, countryCode, phone, branch, status,
    ...
    if (response.statusCode == 201) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(Str.successTxt)));
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => SignInPage()));
    } else {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(Str.suc)));
    }
  }
