...
class DetailRow extends StatelessWidget {
  const DetailRow({Key? key, required this.email, required this.phone, required this.branch, required this.status, required this.emailVerified, required this.}) : super(key: key);
