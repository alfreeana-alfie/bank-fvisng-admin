...
class LoanProductListPage extends StatefulWidget {
  const LoanProductListPage({Key? key, required this.user}) : super(key: key);

  final User user;

  @override
  _LoanProductListPageState createState() => _LoanProductListPageState();
}

class _LoanProductListPageState extends State<LoanProductListPage> {
