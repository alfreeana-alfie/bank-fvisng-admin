...
class ClosedTicketPage extends StatefulWidget {
  const ClosedTicketPage({Key? key}) : super(key: key);

  @override
  _ClosedTicketPageState createState() => _ClosedTicketPageState();
}

class _ClosedTicketPageState extends State<ClosedTicketPage> {
