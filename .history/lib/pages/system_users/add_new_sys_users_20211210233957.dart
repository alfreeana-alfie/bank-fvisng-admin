...
class AddNewSysUserPage extends StatefulWidget {
  const AddNewSysUserPage({Key? key}) : super(key: key);

  @override
  _AddNewSysUserPageState createState() => _AddNewSysUserPageState();
}

class _AddNewSysUserPageState extends State<AddNewSysUserPage> {
