...
class EditSysUserPage extends StatefulWidget {
  const EditSysUserPage({Key? key, required this.user}) : super(key: key);

  final User user;

  @override
  _EditSysUserPageState createState() => _EditSysUserPageState();
}

class _EditSysUserPageState extends State<EditSysUserPage> {
