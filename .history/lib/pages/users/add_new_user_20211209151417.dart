...
class _AddNewUserPageState extends State<AddNewUserPage> {
  ...
  Future addNew(name, email, password, countryCode, phone, branch, status, emailVerified, smsVerified, profilePicture) async {
    final response = await http.put(addNewUser, headers: Values.headers)
  }
  ...
  _buildForm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Email address
        Padding(
          padding: const EdgeInsets.only(bottom: 10, left: Values.horizontalValue * 2, right: Values.horizontalValue * 2),
          child: TextFieldCustom(
