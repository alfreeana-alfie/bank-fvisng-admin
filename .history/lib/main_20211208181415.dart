  ...
  runApp(
    MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          bodyText1: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, letterSpacing:0.5, fontSize: 16, color: Styles.textColor),
          bodyText2: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, letterSpacing:0.25, fontSize: 16, color: Styles.textColor),
