...
class DepositGatewayPage extends StatefulWidget {
  const DepositGatewayPage({Key? key}) : super(key: key);

  @override
  _DepositGatewayPageState createState() => _DepositGatewayPageState();
}

class _DepositGatewayPageState extends State<DepositGatewayPage> {
