...
class WithdrawMethodsPage extends StatefulWidget {
  const WithdrawMethodsPage({Key? key}) : super(key: key);

  @override
  _WithdrawMethodsPageState createState() => _WithdrawMethodsPageState();
}

class _WithdrawMethodsPageState extends State<WithdrawMethodsPage> {
