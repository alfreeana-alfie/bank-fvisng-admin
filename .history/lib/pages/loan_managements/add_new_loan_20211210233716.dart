...
class AddNewLoanPage extends StatefulWidget {
  const AddNewLoanPage({Key? key}) : super(key: key);

  @override
  _AddNewLoanPageState createState() => _AddNewLoanPageState();
}

class _AddNewLoanPageState extends State<AddNewLoanPage> {
