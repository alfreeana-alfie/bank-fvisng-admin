...
class SmsVerifiedPage extends StatefulWidget {
  const SmsVerifiedPage({Key? key}) : super(key: key);

  @override
  _SmsVerifiedPageState createState() => _SmsVerifiedPageState();
}

class _SmsVerifiedPageState extends State<SmsVerifiedPage> {
