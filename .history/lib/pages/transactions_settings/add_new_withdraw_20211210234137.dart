...
class AddNewWithdrawPage extends StatefulWidget {
  const AddNewWithdrawPage({Key? key}) : super(key: key);

  @override
  _AddNewWithdrawPageState createState() => _AddNewWithdrawPageState();
}

class _AddNewWithdrawPageState extends State<AddNewWithdrawPage> {
