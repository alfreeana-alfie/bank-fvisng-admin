...
class DepositMethodsPage extends StatefulWidget {
  const DepositMethodsPage({Key? key}) : super(key: key);

  @override
  _DepositMethodsPageState createState() => _DepositMethodsPageState();
}

class _DepositMethodsPageState extends State<DepositMethodsPage> {
