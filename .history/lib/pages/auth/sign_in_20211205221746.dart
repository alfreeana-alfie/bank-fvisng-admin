          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ClickableText(text: text, selectedTextColor: selectedTextColor, fontSize: fontSize, fontWeight: fontWeight, tapGestureRecognizer: tapGestureRecognizer, margin: margin, alignment: alignment)
              ],
            ),
            // Forgot Password
          ],
