...
class AddNewLoanProductPage extends StatefulWidget {
  const AddNewLoanProductPage({Key? key}) : super(key: key);

  @override
  _AddNewLoanProductPageState createState() => _AddNewLoanProductPageState();
}

class _AddNewLoanProductPageState extends State<AddNewLoanProductPage> {
