...
class MakeWithdrawPage extends StatefulWidget {
  const MakeWithdrawPage({Key? key}) : super(key: key);

  @override
  _MakeWithdrawPageState createState() => _MakeWithdrawPageState();
}

class _MakeWithdrawPageState extends State<MakeWithdrawPage> {
