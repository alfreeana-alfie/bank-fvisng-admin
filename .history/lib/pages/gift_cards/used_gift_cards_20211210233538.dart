...
class UsedGiftCardPage extends StatefulWidget {
  const UsedGiftCardPage({Key? key}) : super(key: key);

  @override
  _UsedGiftCardPageState createState() => _UsedGiftCardPageState();
}

class _UsedGiftCardPageState extends State<UsedGiftCardPage> {
