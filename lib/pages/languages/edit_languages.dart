...
class EditLangPage extends StatefulWidget {
  const EditLangPage({Key? key, required this.user}) : super(key: key);

  final User user;

  @override
  _EditLangPageState createState() => _EditLangPageState();
}

class _EditLangPageState extends State<EditLangPage> {
