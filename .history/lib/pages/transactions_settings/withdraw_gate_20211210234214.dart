...
class WithdrawGatewayPage extends StatefulWidget {
  const WithdrawGatewayPage({Key? key}) : super(key: key);

  @override
  _WithdrawGatewayPageState createState() => _WithdrawGatewayPageState();
}

class _WithdrawGatewayPageState extends State<WithdrawGatewayPage> {
