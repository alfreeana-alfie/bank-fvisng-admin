              ...
              ExpansionTile(
                ...
                children: [
                  Padding(
                    ...
                    child: ClickableText(text: text, selectedTextColor: selectedTextColor, fontSize: fontSize, fontWeight: fontWeight, tapGestureRecognizer: tapGestureRecognizer, margin: margin, alignment: alignment)('1.0'),),
                ],
